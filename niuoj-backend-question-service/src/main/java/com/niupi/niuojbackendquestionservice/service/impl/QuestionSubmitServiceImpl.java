...
import com.niupi.niuojbackendmodel.model.enums.QuestionSubmitLanguageEnum;
...
import com.niupi.niuojbackendquestionservice.mapper.QuestionSubmitMapper;
import com.niupi.niuojbackendquestionservice.rabbitmq.MyMessageProducer;
...
//        });
    ...
    public Page<QuestionSubmitVO> getQuestionSubmitVOPage(Page<QuestionSubmit> questionSubmitPage, User loginUser) {
        ...
        // 1. 关联查询用户信息
        //先将每个用户提交的题目id放在一个集合userIdSet中，然后根据多条id来查用户表listByIds得到用户集合List<User>，然后根据id分组groupingBy得到每个id对应的用户信息详情
        //然后再根据id和原有的题目信息进行匹配，再为对应的题目提交信息填充对应的用户信息
